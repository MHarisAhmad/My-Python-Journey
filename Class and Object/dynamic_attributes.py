...
#----------------------------------------------
#getattr()
#It is the attribute which is used to read an attribute from an object when we don't know its name until runtime.
#If the attribute doesnot exist, it returns AttributeError
class Person: 
...
#additional: the built in dir() function
